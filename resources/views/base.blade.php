...
<head>
    <meta charset="utf-8">
    <title>{{ system_config('site_title') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('layuimini/css/layuimini.css?v=2.0.4.2')}}" media="all">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" layuimini-content-href="{{ route('users.changePasswordForm') }}" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
                        <dd>
                            <a href="{{route('users.logout')}}" class="login-out">退出登录</a>
                        </dd>
                    </dl>
                </li>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin'], function () {
        ...
        miniAdmin.render({
            iniUrl: "{{ route('system.init') }}",    // 初始化接口
            clearUrl: "{{ route('system.clear') }}", // 缓存清理接口
